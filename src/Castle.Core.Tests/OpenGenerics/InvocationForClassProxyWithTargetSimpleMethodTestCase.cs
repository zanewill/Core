...
namespace CastleTests.OpenGenerics
{
	...
	public class InvocationForClassProxyWithTargetSimpleMethodTestCase : BasePEVerifyTestCase
	{
		...
		protected override void AfterInit()
		{
			...
			var one = generator.CreateClassProxyWithTarget(new SimpleGeneric<object>(), interceptor);
