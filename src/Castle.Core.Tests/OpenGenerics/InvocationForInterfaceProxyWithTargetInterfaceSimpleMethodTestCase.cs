...
namespace CastleTests.OpenGenerics
{
	...
	public class InvocationForInterfaceProxyWithTargetInterfaceSimpleMethodTestCase : BasePEVerifyTestCase
	{
		...
		protected override void AfterInit()
		{
			...
			var one = generator.CreateInterfaceProxyWithTargetInterface<ISimpleGeneric<object>>(new SimpleGeneric<object>(),
			                                                                                    interceptor);
