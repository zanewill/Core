...
namespace CastleTests.OpenGenerics
{
	...
	public class InvocationForInterfaceProxyWithTargetSimpleMethodTestCase : BasePEVerifyTestCase
	{
		...
		protected override void AfterInit()
		{
			...
			var one = generator.CreateInterfaceProxyWithTarget<ISimpleGeneric<object>>(new SimpleGeneric<object>(),
			                                                                           interceptor);
